use crate::registry::{GateCtx, GateError}; use cdcp_bank::grounding_wave::{self, Eval};
pub const NAME: &str = grounding_wave::NAME; pub const SUMMARY: &str = grounding_wave::SUMMARY;
