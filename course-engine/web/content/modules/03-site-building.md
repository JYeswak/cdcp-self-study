...
**Queue/BTM operating consequence:** an interconnection path or a behind-the-meter arrangement is not, by itself, a promise of unrestricted dispatch. ERCOT's [April 20–21, 2026 System Operations Update](https://www.ercot.com/files/docs/2026/04/13/8-System-Operations-Update.pdf) describes curtailment instructions for specified large-load categories, including net-metering/co-located arrangements; its look-ahead times and triggers were not finalized in that snapshot. M03 flags the site agreement and category, while Module 15 EOP 4 owns the response. This is an ERCOT process example, not a universal rule for every BTM site or ISO.
