...
| NE-PRE-17 | A hand-typed known-bad count nobody checks | Self-signed certificate about the anti-self-signing machinery; wired by the Rust `verify-injection-count` gate |
