...
| Item bank library | **present** | 957 source files / 931 approved / 25 retired; indexed learner pool 929 (~23.2× exam) — **pool size, not a distinct-proposition count** (see `registries/paraphrase_pairs.toml`) [[fact:fact-bank-item-count-804=yes]] [[fact:fact-bank-approved-count-779=yes]] [[fact:fact-approved-pool-multiplier-19-5=yes]]. Sampler is `cdcp_assemble` (`cdcp goldens fixture`). |
