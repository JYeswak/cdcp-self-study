...
- L2 bank library 957 source files / 931 approved / 26 retired; indexed learner pool 931 (~23.3× exam) + `cdcp_gate verify-bank` + `validate_grounding` [[fact:fact-bank-item-count-804=yes]] [[fact:fact-bank-approved-count-779=yes]] [[fact:fact-approved-pool-multiplier-19-5=yes]]
