...
echo "==> cdcp_gate key-contradiction (bank-internal numeric and negation floor)"
run_cdcp_gate key-contradiction || fail "key contradiction"
ok "bank-internal contradiction floor"
