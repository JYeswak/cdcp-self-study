...
prove the 804 bank item files (779 approved; a pool size, not a distinct-proposition count) [[fact:fact-bank-item-count-804=yes]] [[fact:fact-bank-approved-count-779=yes]] are *correct about data centres*. A wrong answer key is invisible to
